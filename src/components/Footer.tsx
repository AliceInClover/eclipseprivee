      ...
      <div className="container mx-auto px-6">
        <div className="grid gap-10 md:grid-cols-3">
          ...
          <NavGroup title="About">
            ...
            <NavLink href="#">Eclipse Privée</NavLink>
          </NavGroup>
        ...
        <div className="mt-16 flex flex-col items-center justify-between gap-6 border-t border-neutral-800 pt-8 md:flex-row">
          <p className="text-center text-sm text-gray-400">
            © {new Date().getFullYear()} Eclipse Privée Inc. All rights reserved
          </p>
          <TransitionLink
            href="/"
            aria-label="Eclipse Privée Home"
            className="order-first md:order-none"
          >
            <Image src="/logo.svg" alt="ECLIPSE PRIVEE" width={150} height={25} />
          </TransitionLink>
          <ul
            aria-label="Legal"
